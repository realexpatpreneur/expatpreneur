...
export function PodDecision({ id }: { id: string }) {
  ...
  return (
    <form action={action}>
      ...
      <div className="row">
        <button className="btn btn-primary" name="decision" value="actioned" disabled={pending}>
          Make the Pod
        </button>
        <button className="btn btn-ghost" name="decision" value="discussing" disabled={pending}>
          Talking about it
        </button>
        <button className="btn btn-ghost" name="decision" value="not_now" disabled={pending}>
          Not now
        </button>
      </div>
    </form>
  ...
  return (
    <form action={action}>
      ...
      <div className="row">
        ...
        <button className="btn btn-primary" name="status" value="done" disabled={pending}>
          Done
        </button>
        <button className="btn btn-ghost" name="status" value="refused" disabled={pending}>
          Refused
        </button>
      </div>
    </form>
